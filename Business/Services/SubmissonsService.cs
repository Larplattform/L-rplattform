...
namespace Business.Services
{
    public class SubmissonsService : SubmissonsInterface
    {
        ...
        public readonly IAssigmentsRepository _Assignmentrepo;

        public SubmissonsService(ISubmissonsRepository submissonsRepository, IAssigmentsRepository assigmentsRepository)
        {
            _SubmissonsRepository = submissonsRepository;
            _Assignmentrepo = assigmentsRepository;
        }
