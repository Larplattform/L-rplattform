...
namespace Data.Repositories
{
    public class LessonRepository : ILessonRepository
    {
        ...
        public async Task<IEnumerable<Lesson>> AllLessonsWithCoursesAsync()
        {
            ...
            return await _dbContext.Lessons.Include(c => c.Course).ThenInclude(c => c.CourseUsers).Where(c => !c.IsDeleted).ToListAsync();
        }
        ...
        {
            return await _dbContext.Lessons.Include(c => c.Course).ThenInclude(c => c.CourseUsers)
        ...
        {
            return await _dbContext.Lessons.Include(c => c.Course).ThenInclude(c => c.CourseUsers).FirstOrDefaultAsync(c => c.LessonID == courseID && !c.IsDeleted);
        }
